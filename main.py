# main.py
# FINAL ULTIMATE VERSION: Includes CORS fix and Gemini fallback. No database.
...
from starlette.middleware.cors import CORSMiddleware # CRITICAL IMPORT
...
# --- CRITICAL FIX: ADD CORS MIDDLEWARE (Solves WebSocket "Connecting..." issue) ---
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"], 
